...
@Component({
  selector: 'app-imgapicall',
  templateUrl: './imgapicall.component.html',
  styleUrls: ['./imgapicall.component.css']
})
export class ImgapicallComponent implements OnInit {
 element : any;
  @Input() hero: any ;
  @Input() hero1: any ;
  @Input() hero2: any ;
